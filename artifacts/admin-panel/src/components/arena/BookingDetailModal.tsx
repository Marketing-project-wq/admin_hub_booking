            ...
            <>
              {type === 'slot' ? (
                <>
                  ...
                  <div className="detail-row"><span className="detail-label">Sewa</span><span className="detail-value">{booking.rent_type === 'with_coach' ? 'Dengan Coach' : booking.rent_type === 'venue_only' ? 'Venue Saja' : booking.rent_type === 'open_arena' ? 'Open Arena' : booking.rent_type === 'open_arena_month' ? 'Open Arena 1 Month' : '-'}</span></div>
                </>
              ) : (
                <>
