...
export default function ManualBookingModal({ type, onClose, onRefresh }: Props) {
  ...
  // Slot (sewa venue): INFO venue saja atau dengan coach. Penetapan/penjadwalan coach
  // ditangani project lain (coach.dashboard.20fit.id) — di sini cukup penanda saja.
        ...
        <form onSubmit={handleSubmit}>
          {type === 'slot' ? (
            <>
              ...
              <div className="form-group">
                <label>Sewa *</label>
                <select value={rentType} onChange={e => setRentType(e.target.value as 'venue_only' | 'with_coach')}>
